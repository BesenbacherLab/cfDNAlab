...
cargo run --example gen_cli_docs \
  --features cli,docs_gen,cmd_bam_to_bam,cmd_bam_to_frag,cmd_frag_to_bam,cmd_coverage_weights,cmd_fragment_count_weights,cmd_ends,cmd_fcoverage,cmd_gc_bias,cmd_lengths,cmd_midpoints,cmd_outliers,cmd_ref_kmers \
  -- \
