...
To accommodate for common biases, all commands allow sample-specific GC correction and large-scale genomic smoothing (when local changes should not be overshadowed by global differences).

The commands are **highly flexible** with many options and good default settings. See **Guides** in the menu for examples.

Use the **Get Started** section for installation, common input files, and first commands.
