...
sparse_windowed_two_sided_end_zarr_path <- function() {
  fixture_path(
...
sparse_windowed_end_motif_ref_kmer_zarr_path <- function() {
  fixture_path(
...
sparse_windowed_selected_end_motifs_ref_kmer_zarr_path <- function() {
  fixture_path(
