...
axis. The end-motif fixtures cover dense global output, sparse windowed output,
and sparse grouped output with fixed-width ASCII motif labels. The fixtures must
be generated by cfDNAlab itself. Otherwise the suite would only test reader
compatibility with hand-authored approximations of the schemas.
